...
const InteractiveDotCanvas = () => {
  ...
  useEffect(() => {
    ...
    const mouse = {
      x: -1000,
      y: -1000,
      radius: 65, // Controlled interaction zone
    }
    ...
    class Dot {
      ...
      update() {
        ...
        // Subtle elastic displacement (Max ~4px to 5px shift)
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-md flex-col items-center justify-center py-10">
        ...
        <div className="text-center">
          ...
          <p className="mt-3 text-xs md:text-sm font-normal text-zinc-400">
            Access your models, dashboard, and encrypted history.
          </p>
        </div>
        ...
        <div className="mt-8 flex flex-col items-center gap-2 text-center text-xs">
          ...
          >
            Don't have an Elix Account? <span className="text-white font-medium underline underline-offset-4">Create yours now.</span>
          </Link>
        </div>
      </div>
